...
def main():
    ...
    _label_parser = subparsers.add_parser("label", help="Launch labeling webapp")

    # Phase 2: Extract features
    _features_parser = subparsers.add_parser("extract", help="Extract features from labeled tracks")

    # Phase 2: Train models
    _train_parser = subparsers.add_parser("train", help="Train classification models")
    ...
    try:
        if args.command == "label":
            ...
            print("Phase 4: Integrating predictions with Rekordbox XML...")
