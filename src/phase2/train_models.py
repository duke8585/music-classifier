...
from config.config import (
    FEATURES_DIR, MODELS_DIR, ENERGY_LABELS, VIBE_LABELS,
...
class ModelTrainer:
    ...
    def train(self):
        ...
        # Split data
        X_train, X_test, y_energy_train, y_energy_test, y_vibes_train, y_vibes_test = train_test_split(
            X_scaled, y_energy, y_vibes,
            test_size=TEST_SIZE,
            random_state=RANDOM_STATE,
            stratify=y_energy
        )
